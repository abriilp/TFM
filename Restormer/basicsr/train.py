...
sys.path.append("/home/apinyol/TFM/TFM/Restormer")

from basicsr.data import create_dataloader, create_dataset #, build_dataset, build_dataloader
...
def create_train_val_dataloader(opt, logger):
    ...
    for phase, dataset_opt in opt['datasets'].items():
        if phase == 'train':
            ...
            train_loader = create_dataloader(train_set, dataset_opt, num_gpu=opt['num_gpu'],
                                            dist=opt['dist'], sampler=train_sampler, seed=opt['manual_seed'])
...
def main():
    ...
    opt['path']['visualization_dir'] = 'experiments/{}/visualization_val/'.format(opt['name'])
    ...
    while current_iter <= total_iters:
        ...
        while train_data is not None:
            ...
            if opt.get('val') is not None and (current_iter %
                ...
                save_img = 1 if current_iter % opt['val']['save_img_freq'] == 0 else 0
