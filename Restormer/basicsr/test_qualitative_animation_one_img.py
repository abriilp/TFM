...
if __name__ == '__main__':
    ...
    for ckpt in os.listdir('/home/mpilligua/Restormer/experiments/Finetuning_RSR_compiled_Restormer/models/'): 
        if (int(ckpt.split('_')[-1].split('.')[0]) not in [1000, 2000, 5000, 250000]):
            continue
        ...
        img_name = "/home/mpilligua/Restormer/visualizations/magic.jpeg"
        ...
        out_dir = f"/home/mpilligua/Restormer/visualizations/Finetuning_RSR/magic/"
